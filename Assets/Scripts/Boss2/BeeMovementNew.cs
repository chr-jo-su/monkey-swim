...
public class BeeMovementNew : MonoBehaviour {
    ...
    private EnemyHealthBar beeHealth;
    ...
    void Start()
    {
        ...
        beeHealth = gameObject.GetComponentInChildren<EnemyHealthBar>();
    ...
    void Update()
    {
        ...
        if (beeHealth.GetHealth() < beeHealth.GetMaxHealth())
        ...
        if (chasing)
        {
            ...
            spawnPos.y = transform.position.y; // updating spawnPos.y so bee dont teleport back to spawn position after losing aggro
        }
        else
        {
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            beeHealth.TakeDamage(BananarangDamage.instance.GetDamage());
